              ...
              <div className="w-full h-full tablet:p-1">
                <div className="w-full h-full py-16 px-6 flex justify-center items-center rounded-lg tablet:shadow-[0_1px_3px_0_rgba(51,51,51,0.4)] bg-white">
                  <div className="w-full">
                    ...
                    <div className="leading-8 text-xs whitespace-pre-line mt-8 mx-3">
                    </div>
                    <div className="text-xs whitespace-pre-line mt-8 mx-3">
                      {example.map((text, index) => (
                        <span
                          key={index}
                          className={`block ${index % 2 === 0 ? 'leading-normal text-gray-dark mt-4 font-black whitespace-pre-line' : 'leading-normal text-gray-light'}`}
                        >
                          {index % 2 === 0 && (
                            <>
                              <svg className="w-[28px] h-[28px] text-gray-800 dark:text-gray-800 inline-block" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
